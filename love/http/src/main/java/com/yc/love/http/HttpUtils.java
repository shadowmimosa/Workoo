...
import com.yc.love.http.utils.CheckNetwork;
...
public class HttpUtils {
    ...
    public Retrofit.Builder g(String apiUrl) {
...
//            okBuilder.addInterceptor(new ReceivedCookiesInterceptor(context));
            ...
            okBuilder.addInterceptor(new MyHttpLoggingInterceptor()
            ...
            okBuilder.hostnameVerifier(new HostnameVerifier() {
                ...
                public boolean verify(String hostname, SSLSession session) {
                    Log.d("mylog", "verify: hostname " + hostname);
                    Log.d("mylog", "verify: session " + session);
                    Log.d("mylog", "verify:  session.getProtocol() " + session.getProtocol());
                    return true;
                }
            });
