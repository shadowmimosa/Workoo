...
distance_x = [
    770.300, 847.973, 782.993, 818.359, 824.901, 771.679,
    845.102, 789.484
]
distance_y = [
    386.467, 356.796, 416.138, 406.372, 424.388, 372.253,
    428.810, 399.096
]
#城市距离和信息素
...
class TSP(object):
    ...
    def new(self, evt=None):
        ...
        for i in range(len(distance_x)):
            ...
            self.canvas.create_text(
                x,
                y - 10,  # 使用create_text方法在坐标（302，77）处绘制文字
    ...
    def search_path(self, evt=None):
        ...
        while self.__running:
            ...
            # 设置标题
            self.title("TSP蚁群算法(n:随机初始 e:开始搜索 s:停止搜索 q:退出程序) 迭代次数: %d" %
                       self.iter)
            # 更新画布
            self.canvas.update()
            self.iter += 1
