...
if (
  ("object" == typeof AC &&
    "function" == typeof AC.onDOMReady &&
    "object" == typeof AC.Element &&
    "object" == typeof AC.Storage &&
    AC.onDOMReady(function() {
      function e(e, i) {
        var t,
          n,
          r = e.getAttribute("data-analytics-title"),
          a = e.href ? e.getAttribute("href") : "";
        function o(e, i, t) {
          var n = {
              region: i,
              pageName: s.pageName,
              linkText: e,
              eVar1: s.pageName + " | " + i + " | " + e
            },
            r = JSON.stringify ? JSON.stringify(n) : "";
          r &&
            (!1 === isStoreLink(t)
              ? AC.Storage.setItem("ac-storage-apple_Metrics", r, "0")
              : void 0 !== window.localStorage &&
                window.localStorage.setItem("apple_Metrics", r));
        }
        ((t =
          r ||
          ("string" == typeof e.innerText
            ...
            : e.textContent.trim())),
        !0 === isTouchAvailable())
          ? AC.Element.addEventListener(e, "touchstart", function(s) {
              function r(e) {
                n = !0;
              }
              (n = !1),
                AC.Element.addEventListener(e, "touchmove", r),
                AC.Element.addEventListener(e, "touchend", function s(l) {
                  AC.Element.removeEventListener(e, "touchmove", r),
                    AC.Element.removeEventListener(e, "touchend", s),
                    n || o(t, i, a);
                });
            })
          : AC.Element.addEventListener(e, "mouseup", function() {
              o(t, i, a);
            });
      }
      var i = AC.Element.selectAll("#ac-globalnav a");
      (i = i.concat(AC.Element.selectAll("#globalheader a"))).forEach(function(
        i
      ) {
        e(i, "global nav");
      });
      var t = AC.Element.selectAll(".localnav a");
      (t = t.concat(AC.Element.selectAll("#productheader a"))).forEach(function(
        i
      ) {
        e(i, "product nav");
      });
      var n = AC.Element.selectAll(".ac-gf-buystrip a");
      (n = (n = n.concat(AC.Element.selectAll(".buystrip a"))).concat(
        AC.Element.selectAll("#buystrip a")
      )).forEach(function(i) {
        e(i, "buy strip");
      });
      var r = AC.Element.selectAll("#ac-globalfooter a");
      (r = r.concat(AC.Element.selectAll("#globalfooter a"))).forEach(function(
        i
      ) {
        e(i, "global footer");
      });
      var a = AC.Element.selectAll("#ac-familybrowser a");
      (a = a.concat(AC.Element.selectAll(".productbrowser ul li a"))).forEach(
        function(i) {
          e(i, "product browser");
        }
      ),
        AC.Element.selectAll('[data-analytics-region="learn more"] a').forEach(
          function(i) {
            e(i, "learn more");
          }
        );
    }),
  document.location.search && s_account)
) {
  var dls = document.location.search;
  (dls.indexOf("?cid=AOS-") > -1 || dls.indexOf("&cid=AOS-") > -1) &&
    (s_account = "applesupportglobaldev");
}
!(function() {
  var e =
    "checkcoverage.apple.com" === location.hostname
      ? "applesupportglobalprod,appleglobal"
      : "applesupportglobaldev,appleglobal";
  window.s_account = e;
})();
var s = s_gi(s_account);
function safariHandler(e) {
  s.lt(e.href) &&
    e.addEventListener(
      "mouseup",
      function(e) {
          ...
          "d" == s.lt(i) &&
            (i.match(/\.rss|\.xml/)
              ...
              : ((s.eVar11 =
                  ...
                  " - " +
                  i.substring(i.lastIndexOf("/") + 1, i.length)),
...
navigator &&
  ...
  (s._isSafari = !1),
  s.u.toLowerCase().indexOf("webkit") > -1 &&
    s.u.toLowerCase().indexOf("safari") > -1 &&
    s.u.toLowerCase().indexOf("chrome") < 0 &&
    (s._isSafari = !0),
  (s.currencyCode = "USD"),
  window.location.hostname.indexOf(".com.cn") > -1 &&
    (s.fpCookieDomainPeriods = "3"),
  (function() {
    try {
      "undefined" != typeof _applemd &&
        ((s.eVar101 = "_applemd.target.id"),
        (s.eVar102 = "_applemd.target.version"),
        (s.linkTrackVars += ",eVar101,eVar102"));
      var e = location.pathname.match(/(?:\/)(\w\w)(?:\/)(\w\w)/);
      (s.eVar14 =
        e && e.length >= 2
          ? e[2] + "-" + e[1]
          : document.querySelector("html").getAttribute("lang")),
        (s.eVar99 = document.head.querySelector(
          "[name='description']"
        ).content),
        (s.eVar104 = (function() {
          try {
            var e = window.performance || window.Performance,
              ...
              s = {};
            return (
              (s.PF = i.connectEnd.toString().slice(0, 8)),
              (s.TO = e.timeOrigin),
              (s.NV = { a: e.navigation.type, b: e.navigation.redirectCount }),
              (s.timing = {
                a: i.connectEnd.toString().slice(8) || 0,
                b: i.connectStart.toString().slice(8) || 0,
                c: i.domComplete.toString().slice(8) || 0,
                d: i.domContentLoadedEventEnd.toString().slice(8) || 0,
                e: i.domContentLoadedEventStart.toString().slice(8) || 0,
                f: i.domInteractive.toString().slice(8) || 0,
                g: i.domLoading.toString().slice(8) || 0,
                h: i.domainLookupEnd.toString().slice(8) || 0,
                i: i.domainLookupStart.toString().slice(8) || 0,
                j: i.fetchStart.toString().slice(8) || 0,
                k: i.loadEventEnd.toString().slice(8) || 0,
                l: i.loadEventStart.toString().slice(8) || 0,
                m: i.navigationStart.toString().slice(8) || 0,
                n: i.redirectEnd.toString().slice(8) || 0,
                o: i.redirectStart.toString().slice(8) || 0,
                p: i.requestStart.toString().slice(8) || 0,
                q: i.responseEnd.toString().slice(8) || 0,
                r: i.responseStart.toString().slice(8) || 0,
                t: i.unloadEventEnd.toString().slice(8) || 0,
                u: i.unloadEventStart.toString().slice(8) || 0
              }),
              i.secureConnectionStart &&
                (s.timing.s = i.secureConnectionStart.toString().slice(8) || 0),
              JSON.stringify(s).replace(/\"/g, "")
            );
          } catch (e) {}
        })()),
        (s.eVar105 = location.hostname + location.pathname),
        (s.eVar106 = ((i = new Date()),
        (t = i.getTimezoneOffset() / 60),
        (n = t >= 0 ? "-" : "+"),
        i.getHours() + " GMT" + n + Math.abs(t))),
        (s.linkTrackVars += ",eVar103,eVar104,eVar105,eVar106,eVar99");
    } catch (e) {}
    var i, t, n;
  })(),
  ...
  (s.Media.monitor = function(e, i) {
    if (
      "CLOSE" == i.event &&
      (i.percent >= "99" &&
        ((e.Media.trackVars = "prop13,prop16,eVar16"),
        (e.prop13 = "v@e: " + i.name),
        (e.eVar16 = e.prop16 = "video ends"),
        e.Media.track(i.name),
        (e.prop13 = e.prop16 = e.eVar16 = "")),
      i.percent < "99")
    ) {
      var s = e.events,
        t = e.prop13,
        ...
        r = e.prop4,
        a = e.Media.trackVars,
        o = e.Media.trackEvents;
      (e.events = e.prop13 = e.prop16 = e.eVar16 = e.prop4 = ""),
        (e.Media.trackVars = e.Media.trackEvents = ""),
        e.Media.track(i.name),
        (e.events = s),
        (e.prop13 = t),
        (e.prop16 = e.eVar16 = n),
...
if (s_vi_vnum) {
  (date = new Date()).setTime(date.getTime() + 63072e6);
...
function s_getObjectID(e) {
  return e.href;
}
function QTCheck() {
  return AC && void 0 !== AC.Detector && void 0 !== AC.Detector.getQTVersion
    ? AC.Detector.isMobile() || AC.Detector.isiPad()
      ? "mobile"
      : "0" == AC.Detector.getQTVersion()
      ? "no quicktime"
      : "quicktime " + AC.Detector.getQTVersion().split(/\./)[0] + ".x"
    : "quicktime not detected";
}
if (((s.getObjectID = s_getObjectID), "function" == typeof iTunesDetected)) {
...
function s_doPlugins(e) {
  if (((e.tcall = void 0 === e.linkType), e.pageName)) {
    var i = escape(e.pageName);
    (i = (i = (i = i.replace(/(%u2018|%u2019|%u02BC|%u02BD)/g, "%27")).replace(
      /(%u201C|%u201D|%E2%80%9C|%E2%80%9D)/g,
      "%22"
    )).replace(/(%09|%0A|%0D)/g, "")),
      (e.pageName = unescape(i));
  }
  if (
    (e.d.URL.match(
      /(apple.com\/retail\/.+\/map\/|apple.com\/buy\/locator\/|discussions.apple.com|discussionsjapan.apple.com)/g
    ) || e.setupDynamicObjectIDs(),
    window.devicePixelRatio >= 2
      ? (e.prop5 = navigator.platform + " 2x")
      : (e.prop5 = navigator.platform),
    (tempVar1 = e.getQueryParam("ref")),
    tempVar1 && e.tcall
      ? (e.referrer = tempVar1)
      : tempVar1 && !e.tcall && (e.referrer = ""),
    (e.server = e.getQueryParam("alias")),
    e.server || (e.server = "new approach legacy"),
    !e.campaign &&
      ((e.campaign = e.getQueryParam("cid")),
      e.setClickMapEmail("Email_PageName,Email_OID", "Email_OT"),
      e.campaign.match(/OAS-.+?-DOMAINS-/i)))
  ) {
    var s = "http://" + e.campaign.replace(/OAS-.+?-DOMAINS-/i, "");
    e.referrer = e.tcall ? s : "";
  }
  if (
    ((e.campaign = e.getValOnce(e.campaign, "s_campaign", 0)),
    (e.prop6 = e.prop6
      ? e.prop6
      : 'D="' + e.getQueryParam("cp").toLowerCase() + ': "+pageName'),
    (e.prop11 = e.getQueryParam("sr")),
    e.d.URL.match(/\/channel\//) ||
      e.prop11 ||
      !e.c_r("s_3p") ||
      ((e.prop11 = e.c_r("s_3p")), e.c_w("s_3p", "", -1)),
    (e.eVar7 = e.eVar7 ? "" : e.getQueryParam("aid")),
    (e.eVar7 = e.getValOnce(e.eVar7, "s_var_7", 0)),
    e.eVar2 && (e.events = e.apl(e.events, "event6", ",", 1)),
    !e.d.URL.match(
      /apple.com\/(\w{2}|befr|benl|chfr|chde|asia|lae)\/search\//
    ) &&
      !e.d.URL.match(/apple.com\/search\//) &&
      (e.d.referrer.match(
        /apple.com\/(\w{2}|befr|benl|chfr|chde|asia|lae)\/search\//
      ) ||
        e.d.referrer.match(/apple.com\/search\//)))
  )
    if (
      ((e.eVar2 = e.d.referrer.match(/\/support\//)
        ? "acs: "
        : e.d.referrer.match(/\/store\//)
        ? "aos: "
        : "www: "),
      e.d.referrer.match(
        /apple.com\/(\w{2}|befr|benl|chfr|chde|asia|lae)\/search/
      ...
      var t = e.d.referrer.match(/\/(\w{2}|befr|benl|chfr|chde|asia|lae)\//i);
      e.eVar2 += " (" + t[0].replace(/\//g, "") + ")";
    } else
      e.eVar2 +=
        e.getQueryParam("q", "", e.d.referrer).replace(/\+/g, " ") + " (us)";
  if (
    ("em" == e.prop11 && e.tcall && (e.referrer = "imap://chatterbox.com"),
    "app" == e.prop11 && e.tcall && (e.referrer = "file://fromApp"),
    document.referrer &&
      document.referrer.indexOf("apple.com/startpage/") > -1 &&
      e.tcall &&
      ((e.referrer = "news://startpage.com"), (e._1_referrer = 1)),
    !e.prop17)
  ) {
    var n = e.getPercentPageViewed();
    if (n && n.length >= 4 && void 0 !== n[1]) {
      if (
        ((e.prop14 = n[0]),
        (e.prop17 = n[1] + ":" + n[2]),
        (e.prop28 = 10 * Math.round(n[3] / 10)),
        (e.eVar17 = e.eVar18 = ""),
        n[4])
      ) {
        for (var r = n[4].split(/\|/g), a = "", o = 0; o < r.length; o++)
          if (o != r.length - 1) {
            var l = r[o + 1].split(/:/)[0] - r[o].split(/:/)[0];
            if (l > 100) {
              a += r[o].split(/:/)[1];
              for (var c = l / 100; c > 1; ) (a += "0"), c--;
            } else a += r[o].split(/:/)[1];
          } else a += r[o].split(/:/)[1];
        a.length > 254
          ? ((e.eVar17 = a.substring(0, 254)),
            (e.eVar18 = a.substring(255, a.length)))
          : (e.eVar17 = a);
      }
      e.tcall || (e.linkTrackVars = "prop17,prop28");
    }
  }
  if (
    ((e.prop32 = e.eVar32 = e.getQueryParam("psid")),
    e.prop32 || e.c_r("s_sid"))
  ) {
    var f = (b = new Date()).getTime();
    b.setTime(f + 63072e4),
      e.prop32
        ? e.c_w("s_psid", e.prop32, b)
        : e.c_w("s_psid", e.c_r("s_sid"), b),
      e.c_w("s_sid", "", -1);
  }
  e.prop32 || e.c_r("s_pathLength") || (e.prop32 = e.c_r("s_psid")),
    (e.linkLeaveQueryString = !0),
    (p = e.downloadLinkHandler()) &&
      (p.match(/\.rss|\.xml/)
        ? (e.eVar16 = e.prop16 = "sign ups")
        : ((e.eVar11 =
            AC.Tracking.pageName() +
            " - " +
            p.substring(p.lastIndexOf("/") + 1, p.length)),
          (e.eVar16 = e.prop16 = "downloads"),
          (e.events = e.apl(e.events, "event5", ",", 1))),
      (e.linkTrackVars = "prop16,eVar16,eVar11,events"),
      (e.linkTrackEvents = "event5")),
    (e.linkLeaveQueryString = !1),
    "undefined" != typeof Media && e.tcall && (e.prop18 = QTCheck()),
    (function() {
      if (e.u.match(/windows/i)) e.prop9 = "windows";
      else if (e.u.match(/(kindle|silk-accelerated)/i))
        e.u.match(/(kindle fire|silk-accelerated)/i)
          ? (e.prop9 = "kindle fire")
          : (e.prop9 = "kindle");
      else if (e.u.match(/(iphone|ipod|ipad)/i)) {
        var i = e.u.match(/OS [0-9_]+/i);
        e.prop9 = "i" + i[0].replace(/_/g, ".");
      } else if (e.u.match(/android/i))
        e.prop9 = e.u.match(/android [0-9]\.?[0-9]?\.?[0-9]?/i);
      else if (e.u.match(/webos\/[0-9\.]+/i))
        (i = e.u.match(/webos\/[0-9]\.?[0-9]?\.?[0-9]?/i)),
          (e.prop9 = i[0].replace(/webos\//i, "web os "));
      else if (e.u.match(/rim tablet os [0-9\.]+/i))
        (i = e.u.match(/rim tablet os [0-9]\.?[0-9]?\.?[0-9]?/i)),
          (e.prop9 = i[0].replace(/rim tablet os/i, "rim os "));
      else {
        if (
          (e.u.match(/firefox\/(\d{2}||[3-9])/i) ||
            e.u.match(/AppleWebKit\//)) &&
          e.u.match(/Mac OS X [0-9_\.]+/)
        ) {
          var s = e.u.match(/[0-9_\.]+/g);
          return (
            (s = s[1].split(/_|\./)), void (e.prop9 = s[0] + "." + s[1] + ".x")
          );
        }
        var t =
          e.u.match(/AppleWebKit\/\d*/i) &&
          e.u
        ...
        e.prop9 =
          t > 522
            ...
            : t > 80
            ? "10.2.x"
            : "mac unknown or non-safari";
      }
    })(),
    e.pageName &&
      e.pageName.match(/feedback - thank you/) &&
      (e.prop16 = e.eVar16 = "feedback"),
    e.prop13 &&
      (e.tcall || "o" == e.linkType || "" == e.linkType) &&
      e.pageName &&
      !e.pageName.match(/movie trailers -/) &&
      (e.prop13.match(/(v@s|v@r)/i) &&
        ((e.prop16 = e.eVar16 = "video plays"),
        (e.events = "event2"),
        e.tcall ||
          ((e.linkTrackEvents += ",event2"),
          (e.linkTrackVars += ",events,prop16,eVar16"))),
      e.prop13.match(/v@e/i) &&
        ((e.prop16 = e.eVar16 = "video ends"),
        e.tcall ||
          ((e.linkTrackEvents = ""), (e.linkTrackVars += ",prop16,eVar16")))),
    (e.linkLeaveQueryString = !0);
  var p;
  e.linkHandler("itms.apple.com|itunes.apple.com", "e");
  if (
    ((p = e.linkHandler(
      "ax.itunes.apple.com/WebObjects/MZStoreServices.woa/ws/RSS/|rss.support.apple.com",
      "o"
    )) &&
      ((e.eVar16 = e.prop16 = "sign ups"), (e.linkTrackVars = "eVar16,prop16")),
    (e.linkLeaveQueryString = !1),
    e.tcall)
  ) {
    var u,
      ...
      g = !0;
    if (
      ((e.c_r("iTunesPresent") || (e.prop12 && "iTunes" == e.prop12)) &&
        (u = u ? u + "it," : "it,"),
      e.c_r("hasMobileMe") && (u = u ? u + "mm," : "mm,"),
      (e.c_r("DefaultAppleID") ||
        (e.pageName && e.pageName.match(/iforgot - cr or email option/))) &&
        (u = u ? u + "aid," : "aid,"),
      e.c_r("trackStartpage") && (u = u ? u + "sp," : "sp,"),
      e.prop11 && e.prop11.match("3p") && (u = u ? u + "3p," : "3p,"),
      e.pageName &&
        e.pageName.match(/one to one - index/) &&
        (u = u ? u + "o2o," : "o2o,"),
      m.match("/welcomescreen/"))
    )
      (d = m.match("ilife.*"))
        ? ((d = "il" + d.toString().match("[0-9]+") + ","), (u = u ? u + d : d))
        : (d = m.match("iwork.*"))
        ? ((d = "iwk" + d.toString().match("[0-9]+") + ","),
          (u = u ? u + d : d))
        : (d = m.match("itunes.*"))
        ? ((d = "it" + d.toString().match("[0-9]+") + ","), (u = u ? u + d : d))
        : (d = m.match("aperture.*")) &&
          ((d = "ap" + d.toString().match("[0-9]+") + ","),
          (u = u ? u + d : d));
    if (e.getQueryParam("sr") && e.getQueryParam("vr")) {
      var h = e.getQueryParam("vr");
      (h = h.substring(0, h.indexOf("-")) + ","), (u = u ? u + h : h);
    }
    if (void 0 !== u)
      if (
        ((u = (u = u.substring(0, u.length - 1).toLowerCase()).split(",")),
        e.c_r("s_membership"))
      ) {
        var _ = e.c_r("s_membership").split(/:/);
        for (_.splice(0, 1), o = 0; o < u.length; o++) {
          for (j = 0; j < _.length; j++) _[j] == u[o] && (g = !1);
          g && ((_[_.length] = u[o]), (v = !0)), (g = !0);
        }
        if (v) {
          u = _.length + ":" + _.toString().replace(/,/g, ":");
          f = (b = new Date()).getTime();
          b.setTime(f + 63072e3), e.c_w("s_membership", u, b), (e.prop31 = u);
        }
      } else {
        u = u.length + ":" + u.toString().replace(/,/g, ":");
        f = (b = new Date()).getTime();
        b.setTime(f + 63072e3), e.c_w("s_membership", u, b), (e.prop31 = u);
      }
    e.prop31 || e.c_r("s_pathLength") || (e.prop31 = e.c_r("s_membership"));
  }
  if (
    ((function() {
      var i,
        ...
        t,
        n,
        r = ((i = window.location.host),
        (s = document.referrer),
        (t = ""),
        s
          ? -1 === s.split("?")[0].indexOf(i) && (t = "third party")
          : (t = "direct entry"),
        t);
      if (
        (r && "" !== r && (e.prop25 = r), e.tcall && !e.prop25) &&
        (!0 === isStoreLink()
          ? void 0 !== window.localStorage &&
            ((n = window.localStorage.getItem("apple_Metrics")),
            window.localStorage.removeItem("apple_Metrics"))
          : AC &&
            "object" == typeof AC.Storage &&
            ((n = AC.Storage.getItem("ac-storage-apple_Metrics")),
        ...
        (e.prop25 = a.region ? a.region : null),
          (e.eVar1 = a.eVar1 ? a.eVar1 : null),
          a.pageName && (e.prop14 = a.pageName),
          a.events &&
            (e.events ? (e.events += "," + a.events) : (e.events = a.events));
      }
      e.tcall &&
        document.referrer.match(/(downloads|epp|store|storeint)\.apple\.com/) &&
        (e.prop25 = "aos nav"),
        e.prop25 || (e.prop25 = "other nav or none");
    })(),
    ((e.pageName &&
      e.prop14 &&
      e.pageName.toLowerCase() != e.prop14.toLowerCase()) ||
      !e.prop14) &&
      e.tcall)
  ) {
    var k,
      b,
      x = e.c_r("s_pathLength"),
      w = x.indexOf(",") > -1 ? x.split(",") : [];
    f = (b = new Date()).getTime();
    if (
      (b.setTime(f + 18e5),
      (k = e.channel
        ? (k = e.channel.substring(
            e.channel.indexOf(".") + 1,
            e.channel.length
          )).substring(k.indexOf(".") + 1, k.length)
        : "no channel"),
      0 != w.length && w.toString().indexOf(k + "=") > -1)
    ) {
      for (o = 0; o < w.length; o++) {
        if (w[o].toString().indexOf(k + "=") > -1)
          ++(y = w[o].split("="))[1],
            (w[o] = y[0] + "=" + y[1]),
            (e.prop48 = y[1]);
      }
      e.c_w("s_pathLength", w, b);
    } else {
      var y = x + k + "=1,";
      e.c_w("s_pathLength", y, b), (e.prop48 = "1");
    }
  }
  e.tcall && (e.prop50 = e.getVisitNumPerChannel());
  var T,
    O,
    D = e.getQueryParam ? e.getQueryParam("afid") : null;
  D && (e.eVar10 = e.getValOnce ? e.getValOnce(D, "s_afc") : null),
    (T = document.getElementById("top")),
    (O = T ? T.getAttribute("data-analytics-locale") : "") &&
      ((e.prop20 = "aos: " + O),
      (e.prop19 = e.prop20 + (e.pageName ? ": " + e.pageName : "")),
      (e.eVar3 = e.prop20 || "")),
    (e.hier1 = e.channel ? e.channel : ""),
    (e.linkTrackVars = e.apl(e.linkTrackVars, "hier1", ",", 1)),
    (e.prop49 = "D=s_vi"),
    (e.prop4 = e.prop4 ? e.prop4 : "D=g"),
    e.manageVars(
      "lowercaseVars",
...
"undefined" == typeof AC && (AC = {}),
  AC.Tracking || (AC.Tracking = {}),
  (AC.Tracking._pageName = null),
  (AC.Tracking.pageName = function() {
    if (AC.Tracking._pageName) return AC.Tracking._pageName;
    for (
      var e, i = document.getElementsByTagName("meta"), s = 0;
      (e = i[s]);
      s++
    )
      if ("omni_page" === e.getAttribute("name"))
        return (
          (AC.Tracking._pageName = e.getAttribute("content").toLowerCase()),
          AC.Tracking._pageName
        );
  ...
  (AC.Tracking._pageNameForTitle_atHost_andPath = function(e, i, s) {
    var t = e.toLowerCase();
    return (
      /\s-\s/.test(t) &&
        (t = t.replace(
          /\s*-?\s*(apple|Ã£âÂ¢Ã£ÆÆÃ£ÆâÃ£ÆÂ«|Ã¬â¢ Ã­âÅÃ¬Â»Â´Ã­âÂ¨Ã­âÂ°Ã¬Â½âÃ«Â¦Â¬Ã¬â¢â|Ã¨Ëâ¹Ã¦Å¾Å|Ã¨Ëâ¹Ã¦Å¾ÅÃ©âºÂ»Ã¨â¦Â¦|appleÃ¤Â¸Â­Ã¥âºÂ½|Ã¨â¹Â¹Ã¦Å¾ÅÃ¤Â¸Â­Ã¥âºÂ½)\s+[^-]*-?\s*/,
          ""
        )),
      s.match(/^\/(ws|pr|g5|go|ta|wm)\//) ||
        (s = s.replace(/^\/(\w{2}|befr|benl|chfr|chde|asia|lae)(?=\/)/, "")),
      !(s.match(/\//g).length <= 2) ||
        s.match(/support/) ||
        i.match(/support/) ||
        i.match(/selfsolve/) ||
        (!s.match(/index\.html/) && s.match(/\.html/)) ||
        (t += " - index"),
      /\/pr\//.test(s) && (t = "pr - " + t),
      t
    );
  ...
  (s.getVisitNumPerChannel = function() {
    ...
    s.wd.location.hostname.match(/apple.com.cn/)
      ? (u = "cn")
      : p.match(/^\/(ws|pr|g5|go|ta|wm|kb)\//) ||
        (p.match(/^\/(\w{2}|befr|benl|chfr|chde|asia|lae)(?=\/)/) &&
          (u = p.split("/")[1].toLowerCase()));
    var v = "s_vnum_n2_" + u,
      g = "s_invisit_n2_" + u;
    if (
      (s.channel &&
        (o = (o = s.channel.substring(
          s.channel.indexOf(".") + 1,
          s.channel.length
        )).substring(o.indexOf(".") + 1, o.length)),
      (d = (function(e) {
        for (var i = 0; i <= m.length; i++) if (e == m[i]) return i + 1;
      })(o)) || (d = "0"),
      s.c_w("s_vnum_" + u, "", 63072e3),
      s.c_w("s_invisit_" + u, "", 63072e3),
      s.c_w("s_invisit_n_" + u, "", 63072e3),
      s.c_w("s_vnum_n_" + u, "", 63072e3),
      (e = s.c_r(v)),
      (i = s.c_r(g)),
      d)
    ) {
      if (i)
        for (var h = i.split(/,/), _ = 0; (k = h[_]); _++)
          if (d.toString() == k) {
            r = !0;
            break;
          }
      if (!r) {
        ...
        for (_ = 0; (k = b[_]); _++) {
          var x = k.split(/\|/);
          if (d.toString() == x[0]) {
            (n = parseInt(x[1]) + 1), (b[_] = x[0] + "|" + n), (a = !0);
            break;
          }
        }
        return (
          ...
          t.setTime(f),
          a
            ? (s.c_w(v, b.toString(), t), o + "=" + n)
            : (b.toString() ? b.push(d + "|1") : (b = d + "|1"),
              s.c_w(v, b.toString(), t),
              o + "=1")
        );
      }
    }
  ...
  (s.ppv = {
    ...
    scroll: function() {
      ...
      if (100 != e.maxPercent) {
        var i =
          ...
          n = e.getDocHeight();
        n = Math.round(((i + t) / n) * 100);
        if ((e.initialPercent || (e.initialPercent = n), n > e.maxPercent)) {
          e.maxPercent = n;
          var r = [];
          r.push(s.pageName),
            r.push(n),
            r.push(e.initialPercent),
            r.push(i + t),
            sessionStorage.setItem(e.sessionStorageKey, r.join(","));
        }
      }
    },
    ...
    throttle: function(e, i) {
      var s,
        ...
        a = 0,
        o = function() {
          (a = new Date()), (r = null), (n = e.apply(s, t));
        };
      return function() {
        var l = new Date();
        a || (a = l);
        ...
        return (
          ...
          (t = arguments),
          0 >= c
            ? (clearTimeout(r), (r = null), (a = l), (n = e.apply(s, t)))
            : r || (r = setTimeout(o, c)),
          n
        );
      };
...
function s_gi(e, i, s) {
  var t,
    ...
    d = p.appVersion,
    m = d.indexOf("MSIE "),
    v = u.indexOf("Netscape6/");
  if (e && ((e = e.toLowerCase()), f))
    for (r = 0; r < 2; r++)
      for (n = 0; n < f.length; n++)
        if (
          (!(a = (o = f[n])._c) || "s_c" == a || (r > 0 && "s_l" == a)) &&
          (o.oun == e || (o.fs && o.sa && o.fs(o.oun, e)))
        ) {
          if ((o.sa && o.sa(e), "s_c" == a)) return o;
        } else o = 0;
  return (
    ...
    (l = s_d(l)),
    m > 0
      ? (t = parseInt((n = d.substring(m + 5)))) > 3 && (t = parseFloat(n))
      : (t = v > 0 ? parseFloat(u.substring(v + 10)) : parseFloat(d)),
    (t < 5 || d.indexOf("Opera") >= 0 || u.indexOf("Opera") >= 0) &&
      (l = s_ft(l)),
    o ||
      ((o = new Object()),
      c.s_c_in || ((c.s_c_il = new Array()), (c.s_c_in = 0)),
      (o._il = c.s_c_il),
      (o._in = c.s_c_in),
      (o._il[o._in] = o),
      c.s_c_in++),
    (o._c = "s_c"),
    new Function("s", "un", "pg", "ss", l)(o, e, i, s),
    o
  );
}
function s_giqf() {
  ...
  if (n)
    for (e = 0; e < n.length; e++)
      (s = s_gi((i = n[e]).oun)).sa(i.un),
        s.setTagContainer(i.tagContainerName);
  t.s_giq = 0;
}
s_giqf();
