...
class DealEasyjcx(object):
    def __init__(self):
        ...
        self.insert_bid_result = "INSERT INTO `bidpython`.`tb_bid_result` ( `title`, `inviter_number`, `announce_time`, `end_time`, `announce_date`, `platform_id`, `url`, `company`, `announce_company` ) VALUES ( '{网上竞价名称}', '{网上竞价编号}', , '{竞价开始时间}', '{竞价截至时间}' '{成交公告时间}', 15, '{path}', '{采购人}', '{中标公司}' );"
