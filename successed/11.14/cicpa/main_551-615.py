        ...
        for page in range(501, 551):
            ...
            try:
                ...
                self.office_info.to_excel(
                    "./data/office_error_551-615.xlsx", index=False)
                self.staff_info.to_excel(
                    "./data/staff_error_551-615.xlsx", index=False)
                continue

        self.office_info.to_excel("./data/office_551-615.xlsx", index=False)
        self.staff_info.to_excel("./data/staff_551-615.xlsx", index=False)
